...
public class TestBlockBlock extends NetworkcraftModElements.ModElement {
	@ObjectHolder("networkcraft:test_block")
	public static final Block block = null;
	public TestBlockBlock(NetworkcraftModElements instance) {
		super(instance, 9);
	}
